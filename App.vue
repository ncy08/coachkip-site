          ...
          <v-toolbar-items class="hidden-sm-and-down">
            <template v-for="(item, index) in menuItems" :key="index">
              <v-btn
                ...
                flat
                :class="{
                  'active-line': activeSection === item.link.substring(1),
                }"
                :color="
          ...
          >
            <v-row :class="isMobile ? 'mt-10' : 'mt-10'">
              ...
              >
                ...
                >
                  Building a great startup is hard. Really hard. It requires
                  domain expertise, uncommon talent, great execution, great
                  timing, and a little luck. It also requires the ever-elusive
                  great idea. Our team has developed the playbook on how to
                  rapidly validate, refine, and build new businesses.
                </p>
              </v-col>
            </v-row>
          </v-container>
          ...
          >
            <v-row align="center" justify="center">
              ...
              <v-col cols="12" md="5" style="padding-right: 2% !important">
                ...
                >
                  The factors that drive our individual performance interact in
                  complex ways; the first step is bringing them all together.
                  <a
            ...
            <v-row align="center" justify="center">
              ...
              <v-col cols="12" md="5" style="padding-right: 6% !important">
                ...
                >
                  ...
                  and company builders turn a validated concept into a real
                  product in market.
                </p>
              </v-col>
            </v-row>
          ...
          >
            ...
            <v-row :class="isMobile ? 'mt-n2 ' : ''">
              ...
              >
                ...
                >
                  In early testing, our research and models have accounted for
                  an average of 2+ PR’s for each of our alpha users.
                </p>
              </v-col>
            </v-row>
          </v-container>
        ...
        >
          <div style="flex: 1">
            <div class="marquee mb-2">
              <v-row>
                <span v-if="isMobile" class="marquee-label1 mt-n5 ml-1">
                  WORKING IN:</span
                >
                <v-col>
...
<script>
import NickYebra from "../src/assets/image/NickYebra.jpg";
import JamesJackson from "../src/assets/image/JamesJackson.png";
