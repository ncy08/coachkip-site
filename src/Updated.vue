...
<v-footer
  color="#b7e3b6" id="contact"  style=" min-height: 92vh; position: fixed; bottom: 0; left: 0;
    right: 0; display: flex; flex-direction: column; padding: 26px; ">

  <!-- First Row -->
  <div  class="footer-row"  :style="{ marginTop: isMobile ? '30px' : '30px', marginBottom: isMobile ? '7px' : '10px' }">
    ...
    <div class="address-section" :style="{ flex: isMobile ? '0.6' : '0.3', textAlign: 'left' }">
      <div v-if="isMobile" class="footer">ADDRESS</div>
  ...
  <div  class="footer-row" :style="{ marginTop: isMobile ? '10px' : '30px', marginBottom: isMobile ? '7px' : '10px' }">
    <div v-if="!isMobile" class="address-section contact-title">
    ...
    <div class="address-section" :style="{ flex: isMobile ? '0.6' : '0.3', textAlign: 'left' }">
      ...
      <div class="address-details">
        <p>
          <u>+1 206 395 9662<v-icon size="x-small" class="ml-n1">mdi-arrow-top-right</v-icon></u>
        </p>
      </div>
    </div>
  ...
  <div  class="footer-row" :style="{ marginTop: isMobile ? '10px' : '30px', marginBottom: isMobile ? '7px' : '10px' }" >
    ...
    <div class="address-section" :style="{ flex: isMobile ? '0.6' : '0.3', textAlign: 'left' }">
      ...
      <div class="address-details">
        <p>
          <u>work(at)parker.studio <v-icon size="x-small" class="ml-n1">mdi-arrow-top-right</v-icon></u>
        </p>
      </div>
    </div>
    ...
    <div class="address-section" :style="{ flex: isMobile ? '0.6' : '0.3', textAlign: 'left' }">
      ...
      <div class="address-details">
        <p>
          <u>intern(at)parker.studio <v-icon size="x-small" class="ml-n1">mdi-arrow-top-right</v-icon></u>
        </p>
      </div>
    </div>
  </div>
  ...
  <div class="footer-row"   :style="{ marginTop: isMobile ? '10px' : '30px', marginBottom: isMobile ? '7px' : '10px' }">
    ...
    <div class="address-section" :style="{ flex: isMobile ? '0.6' : '0.3', textAlign: 'left' }">
      ...
      <div class="address-details">
        <p>
          <u>Instagram<v-icon size="x-small" class="ml-n1">mdi-arrow-top-right</v-icon></u>
        </p>
      </div>
    </div>
    ...
    <div class="address-section" :style="{ flex: isMobile ? '0.6' : '0.3', textAlign: 'left' }">
      ...
      <div class="address-details">
        <p>
          <u>Tumblr <v-icon size="x-small" class="ml-n1">mdi-arrow-top-right</v-icon></u>
        </p>
      </div>
    </div>
  </div>
        ...
        <div class="marquee-container">
          ...
          <div class="marquee-content">
            <div class="marquee-text">
              SEATTLE <span> (21:07:21),</span> SFO <span> (02:07:21),</span> CHICAGO
              <span> (23:07:21),</span> AUSTIN <span> (23:07:21),</span> NYC
              <span> (00:07:21),</span> LONDON <span> (00:07:21),</span>
            </div>
          </div>
        </div>
      </v-col>
