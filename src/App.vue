<template>
  <v-app >
    ...
    >
      ...
      <v-toolbar v-show="isToolbarVisible" :color="isDarkMode ? '#252423' : 'white'" class="tBar" style="z-index: 1999">
...
<v-parallax :color="isDarkMode ? '#252423' : 'white'" style="position: relative; min-height: 100vh;">
  <div class="hero-content" :style="{paddingTop: isMobile ? '46% !important' : ''}">
    ...
    <div v-if="!isMobile" class="form-container word" :style="{ '--i': 8 }">
      <div class="input-form" :style="{paddingTop: !isMobile ? '30% !important' : ''}">
        <input
          class="input-field"
          type="email"
...
/>
    ...
    <div v-else>
      ...
      <div class="input-form"  :style="{paddingTop: isMobile ? '60% !important' : ''}">
        ...
        <v-btn  :color="isDarkMode ? 'white' : 'black'" variant="elevated" class="mt-3" style="border-radius:30px" size="small">Join Waitlist</v-btn>
...
<section :style="{ minHeight: isMobile ? '50vh' : '100vh'}"  style=" position: relative; border-radius: 0% !important ;z-index: 999;">
  <v-parallax  :color="isDarkMode ? '#252423' : 'white'"  :style="{ minHeight: isMobile ? '50vh' : '100vh'}"  style="position: relative; border-radius: 0% !important;">
...
<section  :style="{ minHeight: isMobile ? '70vh' : '100vh'}" style=" position: relative;
        ...
        <v-parallax :color="isDarkMode ? '#252423' : 'white'"  :style="{ minHeight: isMobile ? '70vh' : '100vh'}" 
...
<section  id="mission" :style="{ minHeight: isMobile ? '90vh' : '100vh'}" style="  position: relative;  border-radius: 0% !important;
      ...
      <!-- //05 - SCALE UP -->
<section id="mission" :style="{ minHeight: isMobile ? '70vh' : '100vh'}" style="  position: relative;  border-radius: 0% !important;
          z-index: 999;  " >
