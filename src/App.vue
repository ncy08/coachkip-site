    ...
    <div color="#252423">
      ...
      >
        ...
        >
          ...
          >
            <v-flex>
              <v-row no-gutters class="mt-4" style="justify-content: center">
                <v-icon
      ...
      <section
        ...
        "
        id="mission"
        @mousemove="handleMouseMove($event, 'What we do')"
        @mouseleave="handleMouseLeave"
      >
        <v-parallax
          color="#252423"
      ...
      >
        ...
        >
          <v-container
            fluid
            :class="!isMobile ? 'services-container' : ''"
            :style="
              !isMobile
                ? {
                    marginLeft: '10px',
          ...
          >
            <div
              :style="{
                'grid-template-columns': isMobile ? '' : 'repeat(2, minmax(250px, 1fr))',
                lineHeight: 2,
              }"
              class="services-grid"
      ...
      <section
        ...
        "
        id="kip"
        @mousemove="handleMouseMove($event, 'How we do it')"
        @mouseleave="handleMouseLeave"
      >
        <v-parallax
          color="#252423"
          ...
          <v-container fluid class="fade-up">
            <v-row align="center" justify="center">
              <v-col cols="12" md="6" class="d-flex justify-center align-center">
                <div
                  @mousemove="handleMouseMove($event, '01—ldeation')"
                  @mouseleave="handleMouseLeave"
                  ref="lottieContainer"
