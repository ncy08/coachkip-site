...
<section  style="position: relative; min-height: 100vh; z-index: 999;" id="home">
  ...
  <section id="home1"  :style="{ minHeight: isMobile ? '50vh' : '80vh'}" style="position: relative; border-radius: 0% !important; z-index: 999;">
...
<section id="whatwedo" :style="{ minHeight: isMobile ? '20vh' : '80vh'}" style="position: relative; border-radius: 0% !important; z-index: 999;" 
...
<section   id="partners" style="position: relative; z-index: 999;" :style="{ minHeight: isMobile ? '80vh' : '100vh'}">
...
<footer style="background: #b7e3b6; min-height: 100vh; top: 0; left: 0; bottom: 0; position: fixed; width: 100%;" v-if="isMobile"  id="contact">
  <div style="display: flex; justify-content: space-between; align-items: flex-start; padding: 30px;padding-top:22%;margin-bottom:5% !important">
    <div style="flex-grow: 1; height: 92vh; display: grid; grid-template-columns: repeat(2, 1fr); ">
      <div style="background: #b7e3b6;">
